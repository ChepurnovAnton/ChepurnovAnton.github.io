...
const MyLoader: FC<MyLoaderProps> = (props) => (
  ...
  >
    ...
    <rect x="206" y="40" rx="10" ry="10" width="85%" height="33" />
    <rect x="207" y="89" rx="10" ry="10" width="85%" height="8" />
    <rect x="206" y="113" rx="10" ry="10" width="85%" height="152" />
  </ContentLoader>
);
